...
//--------------------------------------------------------------------
  ...
  public
    ...
    //       SetRating('*', ..) overwrites an arbitrary rating
    //                         if none is present, a rating with DefaultRatingDescription is created
    function GetRating(aEMail: AnsiString): Byte;
    procedure SetRating(aEMail: AnsiString; Value: Byte);
    function GetPersonalPlayCounter(aEMail: AnsiString): Cardinal;
    procedure SetPersonalPlayCounter(aEMail: AnsiString; Value: Cardinal);
...
var
  DefaultRatingDescription: AnsiString = 'MusoMP3, BlackDot@yahoo.com';
    ...
    if RawHeader.ID = 'ID3' then
      ...
      begin
        ...
        begin
            ...
            Stream.ReadBuffer(ExtendedHeader[0], 6); // Minimum-size is 6bytes
